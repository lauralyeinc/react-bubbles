...
A token is used for a user logging it.  It is used for authentication to make sure the correct user is logged in. Used to access data from an api or database. 

- [ ] What steps can you take in your web apps to keep your data secure?
Private Routes and tokens

- [ ] Describe how web servers work.
Starts at one computer and it sends info to it’s router then to a internet company router and off to the world of computers that shares data from computer to computer (place to place in the world.)
